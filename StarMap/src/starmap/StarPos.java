...
public class StarPos
{
    ...
    public static void main( String [] args )
    {
        ...
        /*
        // this (x,y,z) coordinate system is not used here
            System.out.print( "Enter star's distance from the earth: " );
            double R = sc.nextDouble();
            double x = R * Math.cos( dec ) * Math.cos( ra );
            double y = R * Math.cos( dec ) * Math.sin( ra );
